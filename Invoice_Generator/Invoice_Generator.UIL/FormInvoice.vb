Imports Invoice_Generator.BLL
Imports Invoice_Generator.DAL
...
Public Class FormInvoice
    ...
    Const InvoiceTableSubTotalCol As String = "Sub Total" & vbCrLf & "(After Discount & Tax)"
    ...
    Private Sub FormInvoice_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        Try
            ...
            LblCustDetails2.Text = lstCustomerDetails(0) & vbCrLf & lstCustomerDetails(1) & vbCrLf & lstCustomerDetails(2) & vbCrLf & lstCustomerDetails(3)
